...
public class CreateBlogRequestDTO {
    ...
    @Schema(description = "Blog post title", example = "What 6 years of on-call taught me about writing better errors", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "Title is required")
    @Size(min = 5, max = 300, message = "Title must be between 5 and 300 characters")
    private String title;

    @Schema(description = "Short excerpt shown in feed cards", example = "Every 3am page traces back to an error message that lied to someone.", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "Excerpt is required")
    @Size(min = 10, max = 500, message = "Excerpt must be between 10 and 500 characters")
    private String excerpt;

    @Schema(description = "Cover image URL", example = "https://images.unsplash.com/...")
    ...
    @Schema(description = "List of tag names (max 5)", example = "[\"Engineering\", \"Backend\", \"DX\"]")
